...
{
    protected override IEnumerable<DynamicVar> CanonicalVars => [new DamageVar(30, ValueProp.Move), new BlockVar(10, ValueProp.Move)];
        ...
        CardPlay play)
    {
        ...
        int talis = Owner.Creature.GetPowerAmount<TalismanPower>();
        if (talis > 0)
            return;
